...
<ul style="padding-left:20px">
    <li>Surrounding a Gronckle Iron Armor Piece with Deadly Nadder, Hideous Zippleback, or Night Fury scales will create the respective Dragon Armor.</li>
    <li>Dragon Armor will let you walk through fire, but is not lava resistant.</li>
    <li>Monstrous Nightmare and Gronckle Armor will be added in a future update.</li>
	</ul>
